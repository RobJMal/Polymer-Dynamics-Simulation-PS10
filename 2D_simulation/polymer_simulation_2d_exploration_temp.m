...
P_2d_dynamics_temp = zeros(2,n,size(F_app,2));

parfor i=1:length(T_vals)       % Increasing the applied force value 
    T = T_vals(i); 
    ...
    P_2d_dynamics_temp(:,:,i) = P_temp_i./num_trials;
    
    disp("On the " + num2str(i) + " iteration");
end

save('Results_2D_Simulation_Temp_plot2', 'P_2d_dynamics_temp'); 
